          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse" >
              <ul class="nav navbar-nav navbar-right">
               <li class="active"><a href="TenentHome.jsp">TenentHome</a></li>
                <li><a href="TenentSearch.jsp">Search</a></li>
...
<div class="row register">
  <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
                 ...
                 <%
                        ...
                        List<Map<String, Object>> houses=houseDAO.getTHouseRequest(userId, "Accepted");
                        if(houses!=null&&houses.size()>0)
                        {
                        	...
                        	<table>
                        		...
                        		<%
                        		int sno=1;
                        		ListIterator<Map<String, Object>> li=houses.listIterator();
                        		while(li.hasNext())
                        		{
                        			Map<String, Object> house=li.next();
                        			%>
                        			
                        			<tr>
                        				<td><%=sno %></td>
                        				<td><%=house.get("houseType") %></td>
                        				<td><%=house.get("hsize") %></td>
                        				<td><%=house.get("hno") %></td>
                        				<td><%=house.get("address") %></td>
                        				<td><%=house.get("city") %></td>
                        				<td><%=house.get("state") %></td>
                        				<td><%=house.get("pincode") %></td>
                        				<td><%=house.get("additionalInfo") %></td>

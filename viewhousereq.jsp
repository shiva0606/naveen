...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="#">Home</a> / House Requests</span>
  ...
  <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
               ...
               <%
                    ...
                    <tr>
                        ...
                        List<Map<String, Object>> req=houseDAO.getHouseRequest(new Integer(hid), "Active");
                        if(req!=null&&req.size()>0)
                        {
                        	...
                        	<table>
                        		...
                        		<%
                        		int sno=1;
                        		ListIterator<Map<String, Object>> li=req.listIterator();
                        		while(li.hasNext())
                        		{
                        			...
                        			<tr>
                        				...
                        				<td><a href="reqreply.jsp?hid=<%=hid %>&hrid=<%=m.get("housereqid")%>">Reply</a></td>
                        			</tr>
                        			<%
                        			sno++;
                        		}

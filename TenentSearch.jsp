			...
			<div class="container">
				...
				<div class="navbar-collapse  collapse">
					<ul class="nav navbar-nav navbar-right">
						<li class=""><a href="TenentHome.jsp">TenentHome</a></li>
						<li class="active"><a href="TenentSearch.jsp">Search</a></li>
			...
			<div class="row register">
				<div
					...
					<form action="" method="post">
						...
						</select> <input type="text" class="form-control" placeholder="City"
					...
					<%
										if (houseType != null && city != null) {
											...
											List<House> houses = houseDAO.getHouse(houseType, city);
									...
									<table>
										...
										<tr>
											...
											<td><a href="viewhouse.jsp?hid=<%=house.getHouseId()%>">View
											</a></td>
										</tr>
										<%
											sno++;
